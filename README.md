![image](https://github.com/a3rk/assets/blob/master/remix-ninja-core/images/ninja-core-logo-720-200.png)
...
This repo will be used for the ongoing research and development into running Remix on the TurtleCoin Core
...
- `export CC=gcc-8`
- `export CXX=g++-8`
- `git clone -b master --single-branch https://github.com/a3rk/remix-ninja-core`
- `cd remix`
- `mkdir build`
- `cd build`
- `cmake ..`
...
- `MSBuild Remix.sln /p:Configuration=Release /m`
